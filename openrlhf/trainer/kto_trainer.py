...
class KTOTrainer(ABC):
    ...
    def __init__(
        ...
        if self.vanilla_loss:
            ...
            self.loss_fn = KTOLoss(
                self.beta, 1.0, 1.0, self.strategy.world_size, torch.cuda.current_device()
            )
        ...
        with torch.no_grad():
            ...
            for input_ids, attention_mask, labels in self.eval_dataloader:
                ...
                if self.vanilla_loss:
                    ...
                    aux_loss = policy_returns[3]  # noqa: F841
    ...
    def compute_model_logps(self, model, input_ids, attention_mask, labels):
        ...
        all_logps = self._get_batch_logps(
            all_logits, input_ids, attention_mask=attention_mask, average_log_prob=False
        )
