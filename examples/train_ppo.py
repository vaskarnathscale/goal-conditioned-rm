...
from openrlhf.datasets import NEMO_TEMPLATE, PromptDataset, SFTDataset
...
def train(args):
    ...
    if args.pretrain_data:
        ...
        pretrain_max_len = (
            args.max_len if args.max_len else args.prompt_max_len + args.generate_max_len
        )
    ...
    num_update_steps_per_episodes = (
        len(prompts_dataloader) * args.max_epochs // strategy.accumulated_gradient
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--value_head_strategy", type=str, default="linear")
